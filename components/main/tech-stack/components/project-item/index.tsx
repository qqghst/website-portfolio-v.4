...
const TechStackItem: React.FC<ITechStackItemProps> = ({
	...
	return (
		<div className={styles.techStackItem} onClick={toggleTechStackTools}>
			{showLine && <Line />}
			<div className={styles.techStackItem__container} ref={containerRef}>
				<div className='scrolling-text'>
					<span className='h1' ref={titleRef}>
						{title}
					</span>
				</div>
				<span ref={clickMeRef} className='hide-on-mobile px13'>
					{' '}
					{showTechStack
